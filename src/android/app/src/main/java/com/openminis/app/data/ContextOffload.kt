 ...
 *
 * Linux-visible mount: `/var/minis-autocompact/offloads/tools/<file>`. The host base
 * `filesDir/minis-autocompact-sessions/<sid>/offloads` is bind-mounted into the
...
object ContextOffload {
    ...
    const val LINUX_OFFLOADS_DIR = "/var/minis-autocompact/offloads"
    ...
    fun toolsDir(context: Context, sessionId: String): File =
        File(context.filesDir, "minis-autocompact-sessions/$sessionId/offloads/tools")
