 ...
 *     also accepts a Linux file path under /var/minis-autocompact/... resolved via
...
class SpeechOffloadHandler(private val context: Context) : NativeOffloadHandler {
    ...
    private fun cmdTranscribe(args: OffloadArgs): NativeOffloadResult {
        ...
        // --source: default mic, accept "mic" / "system-mic" / any /var/minis-autocompact/... path.
    ...
    /**
     * Resolve a `/var/minis-autocompact/...`-style Linux path to a host File via
...
EXAMPLES:
  ...
  android-speech transcribe --source /var/minis-autocompact/attachments/meeting.m4a
  android-speech languages
