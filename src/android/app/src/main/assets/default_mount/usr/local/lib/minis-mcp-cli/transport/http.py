...
#
#     /var/minis-autocompact/mcp-servers/oauth/<server>.json
...
OAUTH_DIR = "/var/minis-autocompact/mcp-servers/oauth"
...
def _authorize_deeplink(server_name):
    ...
    return "[Authorize](minis-ac://settings/mcp-servers/%s)" % quote(server_name, safe="")
